...
export const WORKFLOW_SCAFFOLD_STEPS = [
  ...
  {
    id: 'scaffold-wf-auto-run',
    label: 'Writing auto-run.md',
    successMessage: 'Saved ~/.agents/workflows/auto-run.md'
  },
  {
    id: 'scaffold-wf-issue',
    label: 'Writing issue.md',
    successMessage: 'Saved ~/.agents/workflows/issue.md'
  }
];
